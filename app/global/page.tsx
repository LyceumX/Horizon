...
export default function HomePage() {
  ...
  const projectionVersion = useMemo(
    () => `${dob}|${country}|${province}|${city}|${save}|${spend}|$"en"|${hideSensitive ? "hide" : "show"}`,
  ...
  async function saveCloud() {
    ...
    const response = await fetch("/api/profiles", {
      ...
      body: JSON.stringify({
        profile: { dob, age, country, province, city, gender, employmentType, save, spend, budgetMode, language: "en", theme, insurance },
        projection: {
              ...
              <div className="projection-card" key={projectionVersion}>
                ...
                <div className="projection-topline">
                  <div className="projection-title-stack">
                    ...
                    <span className="projection-years-mini">{projection.years} {false ? "年" : "years"}</span>
                  </div>
